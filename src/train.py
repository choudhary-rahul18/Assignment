...
def main():
    ...
    # --- Improvement 5: Weighted Loss for rare entities ---
    class_weights = torch.ones(len(LABEL2ID))

    # Boost weight for rare entities
    rare_entities = ["B-CREDIT_CARD", "I-CREDIT_CARD", "B-DATE", "I-DATE"]
    for ent in rare_entities:
        class_weights[LABEL2ID[ent]] = 2.0   # you can increase to 3.0 if needed
